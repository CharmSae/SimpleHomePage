...
<body>
	...
	$response = @mysqli_query($dbc, "SELECT password FROM poll_reply WHERE id =".$_REQUEST['id']."");
	...
	$query = "DELETE FROM poll_reply WHERE id = ?";
	...
	?>
	<a href="http://subsides.hostei.com/get_poll_content.php?id=<?=$_REQUEST['parents_id']?>">원래글로</a>
